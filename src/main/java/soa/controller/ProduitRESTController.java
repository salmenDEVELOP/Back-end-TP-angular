...
public class ProduitRESTController {
    ...
    public List<Produit> getProduitsPrixSup(@PathVariable Float prix) {
        return produitRepos.findByPrixGreaterThan(prix);
    }
   ...
   public List<Produit> getProduitsPrixSupEtCategorie(@RequestBody CritereRecherche critereRecherche) {

       if (critereRecherche.getCategorie()==null || critereRecherche.getCategorie().equals(new Categorie(null,null,null)))
            {System.out.println(critereRecherche.toString()+" : seulement le prix");
           return produitRepos.findByPrixGreaterThan(critereRecherche.getPrix());}
       else {
           System.out.println(critereRecherche.toString()+": les deux ");
           System.out.println(critereRecherche.getCategorie().toString());
           return produitRepos.findAllByCategorieAndPrixGreaterThan(critereRecherche.getCategorie(), critereRecherche.getPrix());
       }
